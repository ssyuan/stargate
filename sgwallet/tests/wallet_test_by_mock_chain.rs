    ...
    run_with_mock_client(|chain_client| {
        common::with_wallet(chain_client, |rt, alice, bob| {
            rt.block_on(async move {
                ...
                common::execute_script(alice.clone(), bob.clone(), "scripts", "new", vec![TransactionArgument::Address(bob.account())]).await?;
                common::execute_script(bob.clone(), alice.clone(), "scripts", "join", vec![]).await?;
                common::execute_script(
                    alice.clone(),
                    bob.clone(),
                    "scripts",
                    "play",
                    vec![TransactionArgument::Address(bob.account()), TransactionArgument::U64(2), TransactionArgument::U64(2)],
                ).await?;
                common::execute_script(
                    bob.clone(),
                    alice.clone(),
                    "scripts",
                    "play",
                    vec![TransactionArgument::Address(alice.account()), TransactionArgument::U64(3), TransactionArgument::U64(2)],
                ).await?;
                common::execute_script(
                    alice.clone(),
                    bob.clone(),
                    "scripts",
                    "play",
                    vec![TransactionArgument::Address(bob.account()), TransactionArgument::U64(2), TransactionArgument::U64(3)],
                ).await?;
                common::execute_script(
                    bob.clone(),
                    alice.clone(),
                    "scripts",
                    "play",
                    vec![TransactionArgument::Address(alice.account()), TransactionArgument::U64(3), TransactionArgument::U64(3)],
                ).await?;
                common::execute_script(
                    alice.clone(),
                    bob.clone(),
                    "scripts",
                    "play",
                    vec![TransactionArgument::Address(bob.account()), TransactionArgument::U64(2), TransactionArgument::U64(4)],
                ).await?;
                common::execute_script(
                    bob.clone(),
                    alice.clone(),
                    "scripts",
                    "play",
                    vec![TransactionArgument::Address(alice.account()), TransactionArgument::U64(3), TransactionArgument::U64(4)],
                ).await?;
                common::execute_script(
                    alice.clone(),
                    bob.clone(),
                    "scripts",
                    "play",
                    vec![TransactionArgument::Address(bob.account()), TransactionArgument::U64(2), TransactionArgument::U64(5)],
                ).await?;
                common::execute_script(
                    bob.clone(),
                    alice.clone(),
                    "scripts",
                    "play",
                    vec![TransactionArgument::Address(alice.account()), TransactionArgument::U64(3), TransactionArgument::U64(5)],
                ).await?;
                common::execute_script(
                    alice.clone(),
                    bob.clone(),
                    "scripts",
                    "play",
                    vec![TransactionArgument::Address(bob.account()), TransactionArgument::U64(2), TransactionArgument::U64(6)],
                ).await?;
                common::execute_script(
                    alice.clone(),
                    bob.clone(),
