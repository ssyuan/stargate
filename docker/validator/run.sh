...
IMAGE="${1:-starcoin_e2e:latest}"
CONFIGDIR="$(dirname "$0")/../../sgterraform/sgchain/dev/"

SEED_PEERS="$(sed 's,SEED_IP,172.16.0.194,' $CONFIGDIR/seed_peers.config.toml)"
